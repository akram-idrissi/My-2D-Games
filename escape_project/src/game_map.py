...
class GameMap:
    ...
    def draw(self, screen):
        ...
        floor = pygame.image.load("../self.images/floor.png")
        pillar = pygame.image.load("../self.images/pillar.png")
        soil = pygame.image.load("../self.images/soil.png")
        self.images = [floor, pillar, soil]

        for y in range(self.room_height):
            for x in range(self.room_width):
                image_to_draw = self.images[self.room_map[y][x]]
